...
void loop() {
  ...
  for (uint16_t i = 0; i < SAMPLES; i++) {
    vReal[i] = (AMPLITUDE * (sin((i * (TWO_PI * cycles)) / SAMPLES))) / 2.0; /* Build data with positive and negative values*/
    //vReal[i] = (AMPLITUDE * (sin((i * (TWO_PI * cycles)) / SAMPLES) + 1.0)) / 2.0; /* Build data displaced on the Y axis to include only positive values*/
